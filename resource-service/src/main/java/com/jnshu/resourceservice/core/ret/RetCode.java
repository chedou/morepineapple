...
public enum RetCode {
	...
	/**
	 * @Description 根据code message 来构造
	 * @param  [code message]
	 *         code码
	 *         message 信息
	 *
	...
	/**
	 * @Description 判断是否存在 message
	 * @param name (message 名字)
	 * @return 存在，则返回 message
	 * 			不存在，则返回 null
	 * @author Mr.HUANG
	 * @date 2018/12/12
	 */
	...
	/**
	 * @Description 根据 message 返回 code码
	 * @param  name
	 * @return message对应的code码
	 * @author Mr.HUANG
	 * @date 2018/12/12
	 */
