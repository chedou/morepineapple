...
import com.jnshu.reception.dao.CompanyInfoMapper;
import com.jnshu.reception.dao.CompanyProduceMapper;
import com.jnshu.reception.dao.PositionInfoMapper;
import com.jnshu.reception.dao.RecruitingCompanyInformationMapper;
import com.jnshu.reception.pojo.CompanyInfo;
import com.jnshu.reception.pojo.CompanyInfo2;
import com.jnshu.reception.service.CompanyInfoService;
...
public class CompanyInfoServiceImpl implements CompanyInfoService {
    ...
    public List<CompanyInfo2> getCompanyDetail(Long companyId) {
        ...
        List<CompanyInfo2> companyInfo2s = companyInfoMapper.getCompanyDetail(companyId);
        System.out.println(companyInfo2s.toString());
