...
import com.jnshu.reception.pojo.PositionInfo;
import com.jnshu.reception.pojo.PositionInfo2;
import com.jnshu.reception.pojo.Result;
import com.jnshu.reception.service.PositionService;
...
public class PositionInfoController {
    ...
    // TODO: 2018/11/3 搜索职位
    @PostMapping(value = "/search_position_list")
    ...
    @GetMapping(value = "/positionList/four_recommend_position")
    ...
    @GetMapping(value = "/diversity_position_list")
    ...
    // TODO: 2018/11/5 职位介绍
    @GetMapping(value = "/position_info")
